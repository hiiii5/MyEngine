...
protected:
  KeyEvent(const Key::KeyCode keycode) : m_KeyCode(keycode) {}
...
public:
  KeyReleasedEvent(const Key::KeyCode keycode) : KeyEvent(keycode) {}
...
public:
  KeyTypedEvent(const Key::KeyCode keycode) : KeyEvent(keycode) {}
